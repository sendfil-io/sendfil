...
export const TERMS_CONTENT_VERSION = '2026-08-25';
export const TERMS_CONTENT_LAST_UPDATED = 'August 25, 2026';
  ...
  return (
    <article className="mx-auto max-w-3xl">
      ...
      <div className="mt-6 rounded-2xl border border-amber-200 bg-amber-50 px-5 py-4 text-sm leading-6 text-amber-950">
        ...
        <p className="mt-1">
          This initial hosted Service is limited to invited Louisiana business users participating
      ...
      <div className="mt-8 space-y-9">
        <LegalSection number={1} title="Agreement, market, and eligibility">
          ...
          <p>
            <strong>Initial Louisiana Calibration beta only.</strong> For this version of the Terms,
            the <strong>“Eligible Service”</strong> means the closed, by-invitation beta on the
            Filecoin Calibration test network, without a SendFIL service fee, and the sole
            <strong> “Eligible Jurisdiction”</strong> is the State of Louisiana. Mainnet and every
            other network or jurisdiction are outside the Eligible Service even if the interface is
            technically accessible or describes Mainnet-capable features.
          </p>
          <p>
            ...
            beta. A public or forwarded link is not a Valid Invitation, and SendFIL may revoke an
            invitation prospectively.
          </p>
          <p>
            ...
            contract in Louisiana, who ordinarily resides in and is physically located in Louisiana
            while using the Service solely in the course of that person&apos;s trade, business, or
            profession; or (b) an entity organized under Louisiana law with its principal place of
            business in Louisiana, acting through an authorized representative who is physically
            located in Louisiana and has legal age and capacity to form a binding contract. For each
            action, you also represent that every person for whose benefit you act and, to your
            knowledge after reasonable inquiry, each intended recipient is located or organized in
            Louisiana.
          </p>
          <p>
            ...
            for Mainnet use, or for use from any other state, country, territory, or possession.
            Each time you access or use the Service, you represent that the invitation, network,
            geographic, business-use, age, capacity, and authority requirements remain true. You may
            not use a VPN, proxy, location-spoofing method, or other means to misrepresent
            eligibility or evade a restriction.
          </p>
          <p>
            ...
            activity is licensed, registered, or lawful. Any expansion to Mainnet or another
            jurisdiction will require a new dated Terms version, an archived copy, conspicuous
            notice, and renewed affirmative acceptance.
          </p>
          <p>
        ...
        <LegalSection number={19} title="General terms">
          ...
          <p>
            <strong>Governing law; forum.</strong> These Terms and any contractual dispute arising
            out of or relating to them or the Service are governed by the laws of the State of
            Louisiana, without regard to conflict-of-law principles, except to the extent another
            jurisdiction&apos;s non-waivable law applies. Any action or proceeding arising out of or
            relating to these Terms or the Service must be brought exclusively in a state or federal
            court of competent jurisdiction located in Louisiana, unless applicable law gives a
            party a non-waivable right to proceed elsewhere. Each party consents to the personal
            jurisdiction and venue of those courts and waives any objection based on inconvenient
            forum. Nothing in this paragraph deprives any person of a protection or remedy that
