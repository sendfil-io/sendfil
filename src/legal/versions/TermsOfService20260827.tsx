...
export const TERMS_CONTENT_VERSION = '2026-08-27';
export const TERMS_CONTENT_LAST_UPDATED = 'August 27, 2026';
    ...
    <article className="mx-auto max-w-3xl">
      <header>
        ...
        <p className="mt-2 text-sm text-slate-500">
          Effective and last updated {TERMS_CONTENT_LAST_UPDATED}
        </p>
      </header>
      ...
      <div className="mt-6 rounded-2xl border border-amber-200 bg-amber-50 px-5 py-4 text-sm leading-6 text-amber-950">
        ...
        <p className="mt-1">
          This initial hosted Service is limited to invited business users participating
          in a fee-free Calibration test-network beta. SendFIL is a non-custodial interface.
          Blockchain transactions may be irreversible, and SendFIL cannot recover FIL sent to an
          incorrect recipient or network. Review every recipient, amount, fee, network, execution
          method, and wallet prompt before signing.
        </p>
      </div>
      ...
      <nav aria-label="Terms of Service sections" className="mt-6 rounded-2xl bg-slate-50 p-5">
        ...
        <ol className="mt-3 grid gap-x-6 gap-y-2 text-sm text-blue-700 sm:grid-cols-2">
          {[
            'Agreement, market, and eligibility',
            'The Service',
      ...
      <div className="mt-8 space-y-9">
        <LegalSection number={1} title="Agreement, market, and eligibility">
          <p>
            ...
            <strong> “our”</strong>). <strong>“You”</strong> means the individual accepting these
            Terms when acting for that individual&apos;s own trade or business, or the organization
            for which an authorized representative accepts them. In either case, the individual
            personally makes the age, capacity, location, and authority representations in this
            Section but does not become personally liable under these Terms solely by validly
            accepting them for an organization.
          </p>
          <p>
            By checking the Terms acceptance control and then selecting a wallet, or by clicking a
            separate “I agree” control, you acknowledge that you have read, understood, and agree to
            these Terms. After acceptance, these Terms govern each access to and on-chain action
            through the Service. If you do not agree, do not connect a wallet or submit an on-chain
            action through the Service.
          </p>
          <p>
            <strong>Initial invited Calibration beta only.</strong> For this version of the Terms,
            the <strong>“Eligible Service”</strong> means the closed, by-invitation beta on the
            Filecoin Calibration test network, solely for business testing and without a SendFIL
            service fee. Mainnet and every other network are outside the Eligible Service even if
            the interface is technically accessible or describes Mainnet-capable features.
          </p>
          <p>
            A <strong>“Valid Invitation”</strong> means a current, non-transferable written
            invitation issued directly by SendFIL to the named individual or organization for this
            beta. It must identify this Terms version, specify the permitted jurisdictions and
            geographic eligibility restrictions, and be provided to you before you accept these
            Terms. An invitation that omits those details is not valid. A public or forwarded link
            is not a Valid Invitation, and SendFIL may revoke an invitation prospectively.
          </p>
          <p>
            Only the invitation&apos;s restrictions defining eligibility and participation scope
            are incorporated into these Terms. An invitation cannot waive or change these Terms&apos;
            business-use, Calibration-only, fee-free, or other substantive provisions. In
            particular, it cannot authorize Mainnet use, a SendFIL service fee, personal or household
            use, or conduct otherwise prohibited by these Terms.
          </p>
          <p>
            The Eligible Service is offered only to a holder of a Valid Invitation who is (a) a
            natural person at least 18 years old and of legal age and capacity to form a binding
            contract where that person resides and uses the Service, acting solely in the course of
            that person&apos;s trade, business, or profession; or (b) an organization acting through
            an authorized representative who is at least 18 years old and has legal age and capacity
            to form a binding contract.
          </p>
          <p>
            Your invitation must specify the permitted jurisdictions for an individual&apos;s
            ordinary residence and physical place of use; an organization&apos;s jurisdiction of
            organization and principal place of business; its representative&apos;s physical place
            of use; and the persons for whose benefit you act and intended recipients. You must
            satisfy those restrictions for each action and, to your knowledge after reasonable
            inquiry, each beneficiary and intended recipient must satisfy the applicable
            restrictions. Keep a copy of your invitation and the Terms version it identifies.
          </p>
          <p>
            Calibration assets are test assets and must not be treated as having real-world value or
            used to satisfy wages, debts, purchases, investments, or other legal or financial
            obligations. The hosted Service is not offered for personal, family, or household use,
            for Mainnet use, or outside the scope of a Valid Invitation. Each time you access or use
            the Service, you represent that the invitation, network, geographic, business-use, age,
            capacity, and authority requirements remain true. You may not use a VPN, proxy,
            location-spoofing method, or other means to misrepresent eligibility or evade a
            restriction.
          </p>
          <p>
            Technical accessibility does not constitute an offer or invitation to use the Service
            outside this scope and does not mean SendFIL has determined that the Service or your
            activity is licensed, registered, or lawful. No jurisdiction is authorized merely
            because the interface is accessible there. Any expansion to Mainnet, a SendFIL service
            fee, or additional jurisdictions, including a material expansion of your invitation&apos;s
            geographic scope, will require a new dated Terms version, an archived copy,
            conspicuous notice, and renewed affirmative acceptance. An invitation cannot accomplish
            that expansion on its own.
          </p>
          <p>
            If you use the Service for a company, fund, employer, client, nonprofit, or other
            organization, you represent that you are authorized to accept these Terms and initiate
            the relevant transactions on that organization&apos;s behalf. If, notwithstanding the
            restrictions above, applicable non-waivable law treats you as a consumer, nothing in
            these Terms limits or waives any consumer protection, right, remedy, forum, or
            choice-of-law protection that cannot lawfully be limited or waived.
          </p>
        </LegalSection>
        ...
        <LegalSection number={4} title="Your transaction instructions">
          <p>
            ...
            address formats, amounts, absence of a SendFIL service fee, estimated Network Fee,
            execution method, error mode, and wallet prompt.
          </p>
          <p>
        ...
        <LegalSection number={5} title="Batch methods and multisig">
          ...
          <p>
            ...
            recipient payments remain final even when one or more other payments fail.
          </p>
          <p>
            Limits shown by the Service apply to the selected method and configuration. A limit or
            other configuration shown in the interface is a safety control, not an assurance that a
            particular batch is valid or will succeed.
          </p>
          <p>
        ...
        <LegalSection number={6} title="Fees">
          <p>
            ...
            other protocol-level costs (<strong>“Network Fees”</strong>). SendFIL does not receive
            Network Fees. Their amount depends on the transaction instructions and execution method,
            wallet or provider estimates and settings, and network conditions. Estimates may differ
            from the actual fee, and a fee may be charged for a transaction that fails, reverts, is
            delayed, or does not achieve your intended result.
          </p>
          <p>
            The initial Eligible Service does not charge a SendFIL service or platform fee. If the
            review screen or wallet prompt displays a SendFIL fee, a fee-recipient payment, or any
            transfer you did not instruct, the configuration is outside the Eligible Service. Do
            not sign or submit it, and notify SendFIL at the contact in Section 20.
          </p>
          <p>
            SendFIL will not introduce a service fee within this Terms version. A fee-enabled launch
            requires a new dated Terms version, conspicuous disclosure at the transaction decision,
            and renewed affirmative acceptance. SendFIL cannot refund Network Fees or recover
            amounts transferred to recipients, incorrect addresses, or the wrong network.
          </p>
        </LegalSection>
        ...
        <LegalSection number={10} title="Privacy and local data">
          ...
          <p>
            ...
            proposal identifier, execution method or mode, recipient count, aggregate value, warning
            or error information, and timestamps. Wallet and wallet-connection libraries may
            separately use browser storage, including local storage or IndexedDB, for connector
        ...
        <LegalSection number={12} title="Taxes and legal compliance">
          ...
          <p>
            ...
            transaction would be unlawful. The geographic and business-use limits in Section 1 do
            not replace your obligation to determine whether you and each transaction comply with
            applicable law.
          </p>
        </LegalSection>
        ...
        <LegalSection number={15} title="Changes, availability, and termination">
          <p>
            ...
            third-party availability, or protection of users and the Service. We will not expand the
            Eligible Service&apos;s jurisdiction, network, or fee scope under this Terms version; an
            expansion requires the new version and renewed acceptance described in Section 1.
          </p>
          <p>
        ...
        <LegalSection number={17} title="Limitation of liability">
          ...
          <p>
            ...
            claims arising from or relating to the Service or these Terms will not exceed US$100.
          </p>
          <p>
            These limitations do not apply to liability of SendFIL or any other person otherwise
            protected by this Section for fraud, fraudulent misrepresentation, intentional or gross
            fault, willful misconduct, or causing physical injury, or to any other liability that
        ...
        <LegalSection number={19} title="General terms">
          ...
          <p>
            You may retain these Terms by printing or saving the linked Terms page through your
            browser. You may also request a copy of the Terms applicable to a particular effective
            date by contacting the address in Section 20.
          </p>
          <p>
