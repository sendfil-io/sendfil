...
function getBaseProps(): ReviewTransactionModalProps {
  return {
    ...
    validationErrors: [],
    validationWarnings: [],
    recipientTotalAttoFil: 1_000_000_000_000_000_000n,
    feeTotalAttoFil: 10_000_000_000_000_000n,
    gasEstimate: {
      gasLimit: 1000,
      gasFeeCap: '1',
      gasPremium: '1',
      estimatedFeeAttoFil: 1_000_000_000_000_000n,
      estimatedFeeInFil: 0.001,
    },
    isEstimatingGas: false,
    gasEstimationError: undefined,
    walletBalanceAttoFil: 10_000_000_000_000_000_000n,
